          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <div class="row">
                    <div class="col-sm-6">
                        <h6 class="text-white text-capitalize ps-3">Hutang Hutang</h6>
                    </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Jatuh Tempo</th>
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="text-xs text-secondary mb-0"> 
                          <a href="/debt/{{$item->id}}/detail" class="text-primary fw-bold">
                      ...
                      <td>
                        <p class="text-xs text-secondary font-weight-bold mb-0"> {{$item->last_tanggal}} </p>
                      </td>
                      <td>
                        <p class="text-xs text-secondary font-weight-bold mb-0"> {{substr($item->last_due_date, 0, 10)}} </p>
                      </td>
                      <td class="align-middle text-sm">
                        <p class="text-xs @if($item->jumlah < 0) text-success @endif fw-bold mb-0"> {{number_format($item->total_jumlah)}} </p>
                      </td>
                      <td class="align-middle text-sm">
